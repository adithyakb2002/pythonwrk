...
class Booknow_display(admin.ModelAdmin):
    list_display=['name','email','phone','requirment']

class Subnewsevents_display(admin.ModelAdmin):
    list_display=['heading','paragraph','images','descriptions']
    
class Visiting_display(admin.ModelAdmin):
    list_display=['place','Location','Location1','description']    
...
admin.site.register(Subnewsevents,Subnewsevents_display)
admin.site.register(Booknow,Booknow_display)
admin.site.register(Visiting,Visiting_display)